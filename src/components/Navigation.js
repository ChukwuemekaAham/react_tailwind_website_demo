...
const Navigation = () => {
  return (
    ...
    <nav class="px-6 fixed w-full top-0 right-0 bg-blue-200 flex items-center justify-center py-6 z-40">
		<div class="flex justify-between items-center max-w-8xl w-full">
			<div class="cursor-pointer">
				<svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 842 168" role="img">
				    
				  <path class="st3" fill="#2a3b47" 
			...
			<div class="hidden lg:flex flex-grow">
				...
				<a href="#" class="flex items-center ml-8 text-sm text-gray-700 font-light hover:text-gray-900">Resources
						<svg class="ml-1 h-4 w-4 fill-current" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink">
						<g id="Page-1" stroke="none" stroke-width="1" fill-rule="evenodd">
							<g id="icon-shape">
								<polygon id="Combined-Shape" points="9.29289322 12.9497475 10 13.6568542 15.6568542 8 14.2426407 6.58578644 10 10.8284271 5.75735931 6.58578644 4.34314575 8"></polygon></g>
				...
				<a href="#" class="flex items-center ml-8 text-sm text-gray-700 font-light hover:text-gray-900">Education
						<svg class="ml-1 h-4 w-4 fill-current" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink">
						<g id="Page-1" stroke="none" stroke-width="1" fill-rule="evenodd">
							<g id="icon-shape">
								<polygon id="Combined-Shape" points="9.29289322 12.9497475 10 13.6568542 15.6568542 8 14.2426407 6.58578644 10 10.8284271 5.75735931 6.58578644 4.34314575 8"></polygon></g>
				...
				<a href="#" class="flex items-center ml-8 text-sm text-gray-700 font-light hover:text-gray-900">Pricing</a>
			</div>
			<div>
				<a href="#" class="text-sm text-gray-700 font-light hover:text-gray-900">Log in</a>
				<a href="#" class="ml-4 px-4 py-3 text-sm text-white font-light bg-blue-500 rounded hover:bg-blue-400">Free Trial</a>
			</div>
		</div>
